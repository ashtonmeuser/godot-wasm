...
A simple example of loading a Wasm module, accessing its exporte globals, and calling its exported functions. The Wasm module used is that generated by the [Wasm Create example](#wasm-create-assemblyscript). All logic for this Godot project exists in `Main.gd`.
